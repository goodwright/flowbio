...
.. version-deprecated:: 0.3.7
   The legacy client is being phased out. Use :class:`flowbio.v2.Client` instead.
...
.. autoclass:: flowbio.Client
   :members: login, data, upload_data, upload_sample, upload_annotation, upload_multiplexed, sample, run_pipeline, execution, execute, refresh_token, user
